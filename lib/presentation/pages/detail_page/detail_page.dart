...
import 'package:digi_flix/presentation/providers/movie/movie_detail/movie_detail_provider.dart';
...
class DetailPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    var asyncMovieDetail = ref.watch(
      MovieDetailProvider(
        movie: movie,
      ),
    );
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    verticalSpace(24),
                    ...movieShortInfo(asyncMovieDetail: asyncMovieDetail, context: context),
                    verticalSpace(20),
